...
GOOGLE_CLIENT_ID = os.getenv("GOOGLE_CLIENT_ID")  #get the client id from the environment variables
client_secrets_file = os.path.join(pathlib.Path(__file__).parent, os.getenv("SECRET_FILE"))  #set the path to where the .json file you got Google console is
